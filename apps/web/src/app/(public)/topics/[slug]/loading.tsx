...
export default function TopicLoading() {
  return (
    <div className="mx-auto max-w-4xl px-6 py-8">
      ...
      <div className="rounded-3xl border border-border/40 p-8 mb-6 delay-75">
      ...
      <div className="grid gap-4 sm:grid-cols-2 mb-6">
        <div className="rounded-3xl border border-border/40 p-6 delay-150">
          <Skeleton className="h-3 w-24 mb-3 rounded-full" />
          <Skeleton className="h-4 w-full mb-1 rounded-md" />
          <Skeleton className="h-4 w-2/3 rounded-md" />
        </div>
        <div className="rounded-3xl border border-border/40 p-6 delay-225">
          <Skeleton className="h-3 w-24 mb-3 rounded-full" />
          <Skeleton className="h-4 w-full mb-1 rounded-md" />
          <Skeleton className="h-4 w-2/3 rounded-md" />
        </div>
